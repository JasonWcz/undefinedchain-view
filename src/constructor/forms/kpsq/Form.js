...
class Form extends Component {
    ...
    routeTo(id,condition) {
        this.props.history.push({pathname: '/constructor/detail0/'+id+'/'+condition})
    }

    btnFn(){
        this.props.history.push('/constructor/application0')
    }
    ...
    render() {
        return(
            <div id="jpyw_form">
                ...
                <header>
                    <button type="button" id="apply0" onClick={this.btnFn.bind(this)}>申请</button>
                    <form action="#" id="jpsearch0">
                        <img src={imgURL} id='icon0'/>
                        <input type="search" placeholder="输入金票编号" id="jpvalue0"/>
                    </form>
                </header>
