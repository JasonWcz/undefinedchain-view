...
class Form extends Component {
    ...
    translateTo(id,select){
        ...
        else if(jprz1.indexOf(select) != -1){
            switch (select) {
                case '融资待受理':
                    condition = '待受理';
                    break;
    ...
    routeTo(id,condition) {
        if(kpsq.indexOf(condition) != -1) this.props.history.push({pathname: '/constructor/detail0/'+id+'/'+condition})
        else if(jprz.indexOf(condition) != -1) this.props.history.push({pathname: '/constructor/detail1/'+id+'/'+condition})
        else this.props.history.push({pathname: '/constructor/detail2/'+id+'/'+condition})
    }
                ...
                <header id="header1">
                    <form action="#" id="jpselect">
                        ...
                        <select>
                            ...
                            <option value ="转让待签收">转让待签收</option>
                            <option value ="转让已驳回">转让已驳回</option>
                            <option value ="转让已签收">转让已签收</option>
                        </select>
                        <span>开票企业：</span>
                        <select>
                            <option value ="请选择">请选择</option>
                    ...
                    <table class="jpyw_table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>2019-12-31</td>
                                <td>100000</td>
                                <td><a onClick={()=>this.translateTo('11223948101329424211102','申请已驳回')}>详情</a></td>
                            </tr>
                            <tr>
                                ...
                                <td>2019-12-31</td>
                                <td>100000</td>
                                <td><a onClick={()=>this.translateTo('11223948101329424211103','融资已受理')}>详情</a></td>
                            </tr>
                            <tr>
                                ...
                                <td>2019-12-31</td>
                                <td>100000</td>
                                <td><a onClick={()=>this.translateTo('11223948101329424211104','放款待签收')}>详情</a></td>
                            </tr>
                            <tr>
                                ...
                                <td>2019-12-31</td>
                                <td>100000</td>
                                <td><a onClick={()=>this.translateTo('11223948101329424211105','转让已签收')}>详情</a></td>
                            </tr>
                        </tbody>
                    </table>
