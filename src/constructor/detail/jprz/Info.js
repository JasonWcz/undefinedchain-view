...
class Info extends Component {
    ...
    showReason = () => {
        if (this.state.condition == "收款驳回" || this.state.condition == "申请驳回"){
            this.setState({
                showElem: true
            });
        }
            ...
            <div>
                ...
                <div className="out-border">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td className="t-right">xxx保理商</td>
                            <td className="t-left">操作人：</td>
                            <td className="t-right">张三三</td>
                        </tr>
                        <tr>
                            <td className="t-left">备注：</td>
                            <td className="t-right">xxxxxx</td>
                            <td className="t-left">融资进度：</td>
                ...
                <div className="out-border">
                    <table>
                        <tbody>
                        <tr>
                            <td className="t-left">融资企业：</td>
                            <td className="t-right">xxx施工公司</td>
                            <td className="t-left">融资时间：</td>
                            <td className="t-right">2019-12-25</td>
                        </tr>
                        <tr>
                            <td className="t-left">融资金额：</td>
                            <td className="t-right">800</td>
                        ...
                        <tr>
                            ...
                            <td className="t-right">中国工商银行</td>
                            <td className="t-left">融资备注：</td>
                            <td className="t-right">xxxxxx</td>
                        </tr>
                        </tbody>
                    </table>
